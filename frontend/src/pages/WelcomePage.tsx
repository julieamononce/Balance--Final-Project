    ...
    <div>
        ...
        <div className="mb-6 px-5">
                ...
                <div className="grid justify-center grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0 ml-20 mt-20">
                    ...
                    <Card title = "Calendar" description="Track your emotions, assignments & upcoming exams." image = "/calendaricon.png" shadow="shadow-lg shadow-pink-500/50" className="bg-transparent" width="w-90"/> 
                </div>
